 ...
 * @return void
 */
function wp_email_capture_admin_scripts($hook)
{
       /* Register our stylesheet. */

       if ('capture_page_wpemailcapturefreesettings' == $hook || 'toplevel_page_wpemailcapture' == $hook || 'capture_page_wpemailcapturefreehelp' == $hook || 'index.php' == $hook || strpos( $hook, 'wpemailcapture' ) != false || strpos( $hook, 'wp-email-capture' ) != false ) {
